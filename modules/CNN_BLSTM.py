...
class CNN_BLSTM(object):
    ...
    def __init__(self, class_, type, propertyName, EPOCHS, DROPOUT, DROPOUT_RECURRENT, LSTM_STATE_SIZE, CONV_SIZE, LEARNING_RATE, OPTIMIZER):
        ...
        # save model
        self.modelName = "{}_{}_{}_{}_{}_{}_{}_{}_{}".format(type, propertyName, self.epochs,
                                                       self.dropout,
    ...
    def predict(self, model, sentence):
        ...
        pred = model.predict([tokens_np, casing, char], verbose=False)[0]
